...
function PokemonCacheProvider(props){
  ...
  //using the jsx foo.Provider value = x to set the props.children
} //looking good.

function usePokemonCache(){
  const context = React.useContext(PokemonCacheContext) //minor bug, was using PokemonCacheProvider instead of context.
  if(!context){
...
function PokemonSection({onSelect, pokemonName}) {
  ...
  ) //Elements wrapped i the PokemonCacheProvider as to hace access to the useContext hook variable.
}
