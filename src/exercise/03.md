...
Fill out
[the feedback form](https://ws.kcd.im/?ws=Advanced%20React%20Hooks%20%F0%9F%94%A5&e=03%3A%20useContext%3A%20simple%20Counter&em=josh.e.fielding%40gmail.com).

## 🦉 My Notes

Context provides a way to pass data through the component tree without having to
pass props down manually at every level. Context provides a way to share values
like these between components without having to explicitly pass a prop through
every level of the tree.

Useful resources : (https://devtrium.com/posts/how-use-react-context-pro)

`const CountContext = React.createContext()` returns an object with two
properties: `{Provider, Consumer}` A component calling `useContext` will always
